...
const countuppers = [];
let counter = 0;
document.addEventListener('aos:in:count-up', ({
  detail
}) => {
  ...
  countuppers[counter] = new countUp_js__WEBPACK_IMPORTED_MODULE_1__.CountUp(detail.children[0], detail.dataset.aosTargetValue, {
...
document.addEventListener('aos:out:count-up', ({
  detail
}) => {
