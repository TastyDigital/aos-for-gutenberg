...
const gutenbergAOSControls = createHigherOrderComponent(BlockEdit => {
  return props => {
    if (props.name.substring(0, 5) !== 'core/') {
      return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(BlockEdit, props));
    }
    const {
      attributes,
      setAttributes,
    ...
    return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(BlockEdit, props), isSelected && /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      title: __('AOS Settings', 'gutenberg-aos')
      ...
      onChange: () => setAttributes({
        gutenbergUseAOS: !gutenbergUseAOS
      }),
      ...
      onChange: gutenbergAOSAnimation => props.setAttributes({
        gutenbergAOSAnimation: gutenbergAOSAnimation
      })
    })))));
  };
...
addFilter('blocks.registerBlockType', 'gutenbergaos/attributes', gutenbergAOSAttributes);
addFilter('editor.BlockEdit', 'gutenbergaos/controls', gutenbergAOSControls);
addFilter('blocks.getSaveContent.extraProps', 'gutenbergaos/applyAttributes', gutenbergAOSApplyAttributes);
/******/ })()
;
