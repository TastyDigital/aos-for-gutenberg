...
This WordPress plugin is licensed under the GNU General Public License v2.0 or later.
...
This plugin includes the [AOS (Animate On Scroll)](https://github.com/michalsnik/aos) library:
